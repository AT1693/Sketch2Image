...
class DataLoader():
    ...
    def load_data(self, batch_size=1, is_testing=False):
        path = string(glob('./samples/*' % (self.dataset_name))
...
gan.generator.load_weights('maps2buildings_generator.h5')
gan.discriminator.load_weights('maps2buildings_discriminator.h5')
